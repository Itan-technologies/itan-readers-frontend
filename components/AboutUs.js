  ...
  return (
    <section className="px-4 py-10 large:py-4 xl:py-0 xl:px-8">
      ...
      <article className="m-6">
        <div className="large:flex xl:flex large:items-start xl:items-start large:gap-8 xl:gap-12 large:p-4">
          <figure className="mx-auto large:mx-0 xl:mx-0 w-full max-w-xs large:max-w-none xl:max-w-none large:w-1/4 xl:w-1/5 large:sticky large:top-8 xl:sticky xl:top-8">
            <img
              src="/images/books.png"
              alt="books"
              className="w-full h-auto large:w-full xl:w-full"
            />
          </figure>

          <div className="medium:w-full large:w-3/4 xl:w-4/5">
            <h2 className="text-center medium:text-start large:text-start xl:text-start text-2xl font-bold large:text-3xl xl:text-5xl">
              Let the World{" "}
              <span className="text-[#EF5353]">Read and Listen</span> to your
              Unique Story
            </h2>
            <h2 className="font-semibold text-2xl mt-6 medium:px-4 large:px-0 large:text-3xl xl:text-4xl xl:mt-12">
        ...
        <div className="bg-[#E7E7E7] mt-4 p-4 large:p-6 xl:p-8 large:m-6 xl:m-8">
          <h3 className="medium:mt-8 large:mt-8 xl:mt-8 text-2xl font-bold large:text-3xl xl:text-4xl">
          ...
          <div className="large:flex xl:flex xl:flex-8 xl:items-center xl:justify-between large:justify-between xl:text-3xl">
            ...
            <figure className="xs:flex xs:items-center large:block mt-6 medium:hidden">
              <img
