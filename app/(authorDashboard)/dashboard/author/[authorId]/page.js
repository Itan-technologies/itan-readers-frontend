...
const AuthorDashboard = () => {
  ...
  <div className="py-4  grid grid-cols-3">
   ...
   <div className='col-span-2 h-10'>
    ...
    <div className="flex flex-col items-center justify-center p-7 bg-gray-200 rounded-2xl w-56 h-48 cursor-pointer">
        <img className="w-16 h-16 mb-2" src="/images/ebook.png" alt="Ebook"/>
        <h5 className="mb-1 text-lg font-medium text-gray-900 dark:text-white">E-Books</h5>   
    </div>
    <div className="flex flex-col items-center p-7 bg-gray-200 rounded-2xl w-56 h-48 justify-center cursor-pointer">
        <img className="w-16 h-16 mb-2" src="/images/audiobook.png" alt="Ebook"/>
        <h5 className="mb-1 text-lg font-medium text-gray-900 dark:text-white">Audiobooks</h5>   
    </div>
    <div className="flex flex-col items-center p-7 bg-gray-200 rounded-2xl w-56 h-48 justify-center cursor-pointer">
        <img className="w-16 h-16 mb-2" src="/images/book-series.png" alt="Ebook"/>
        <h5 className="mb-1 text-lg font-medium text-gray-900 dark:text-white">Book Series</h5>   
    </div>
    </div>
