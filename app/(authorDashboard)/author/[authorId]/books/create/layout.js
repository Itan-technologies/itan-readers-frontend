...
const layout = ({ children }) => {
  ...
  return (
    <div className="mx-2  lg:ml-72 lg:mr-8  lg:mt-24 lg:container lg:mx-auto">
      <h3 className="font-semibold text-lg mb-3">Add an Ebook</h3>

      <div className="lg:hidden relative">
        <p className="text-[#B6B6B6] w-full max-w-[650px] border-dashed border-0 border-t-2 border-gray-400" />
        <div className="absolute -bottom-3 w-full max-w-[650px]">
