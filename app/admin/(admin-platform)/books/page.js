            ...
            <TableHeader>
              <TableRow className="bg-transparent hover:bg-transparent">
                <TableCell colSpan={6} className="p-0">
                  <div className="bg-slate-700 hover:bg-slate-700 rounded-lg flex items-center px-4 py-2">
                    <div className="w-[100px] text-white">Book Name</div>
                    <div className="flex-1 text-white">Author</div>
                    <div className="flex-1 text-white">Book Types</div>
                    <div className="flex-1 text-white">Book Status</div>
                    <div className="flex-1 text-white">Date</div>
